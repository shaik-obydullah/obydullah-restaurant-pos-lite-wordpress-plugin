...
Go to **Restaurant POS → Settings** to configure tax rates, VAT rates, currency, and other shop settings. You can enable/disable these features as needed.
...
Go to **Restaurant POS → Dashboard** for an overview of today's and monthly sales, income, expenses, and profits. The Sales section provides detailed transaction history.
...
Yes, the plugin is fully translation-ready and includes .pot file for translators. Text domain: `obydullah-restaurant-pos-lite`.
