                    ...
                    <div class="bg-light p-4 rounded shadow-sm">
                        ...
                        <div class="orpl-categories-list" id="orpl-categories-list">
                            ...
                            <span class="spinner-border spinner-border-sm text-primary" role="status">
                                <span
                                    class="sr-only"><?php esc_html_e('Loading...', 'obydullah-restaurant-pos-lite'); ?></span>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-light p-4 rounded shadow-sm">
                        ...
                        <div class="orpl-stocks-grid" id="orpl-stocks-grid">
                            ...
                            <div class="text-center py-5">
                                ...
                                <p class="mt-2">
                                    <?php esc_html_e('Loading stocks...', 'obydullah-restaurant-pos-lite'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-light p-4 rounded shadow-sm">
                ...
                <div class="form-group mb-3">
                    ...
                    <select id="orpl-customer" class="form-control">
                        <option value=""><?php esc_html_e('Walk-in Customer', 'obydullah-restaurant-pos-lite'); ?>
                        </option>
                    </select>
                </div>
                ...
                <div class="pos-order-tabs mb-3">
                    ...
                    <div id="dineInOptions" class="pos-tab-content">
                        <div class="form-group mb-2">
                            <label
                                class="form-label"><?php esc_html_e('Table Number', 'obydullah-restaurant-pos-lite'); ?></label>
                        ...
                        <div class="form-group mb-0">
                            <label
                                class="form-label"><?php esc_html_e('Cooking Instructions', 'obydullah-restaurant-pos-lite'); ?></label>
                    ...
                    <div id="takeAwayOptions" class="pos-tab-content" style="display: none;">
                        <div class="form-group mb-2">
                            <label
                                class="form-label"><?php esc_html_e('Customer Name', 'obydullah-restaurant-pos-lite'); ?></label>
                        ...
                        <div class="form-group mb-2">
                            <label
                                class="form-label"><?php esc_html_e('Delivery Address', 'obydullah-restaurant-pos-lite'); ?></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group mb-2">
                                    <label
                                        class="form-label"><?php esc_html_e('Email', 'obydullah-restaurant-pos-lite'); ?></label>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-2">
                                    <label
                                        class="form-label"><?php esc_html_e('Mobile', 'obydullah-restaurant-pos-lite'); ?></label>
                ...
                <div class="mb-3">
                    <div class="bg-white p-3 rounded border">
                        <table class="table table-sm table-borderless mb-0">
                            <tbody>
                                <tr>
                                    <td class="pl-0"><?php esc_html_e('Subtotal:', 'obydullah-restaurant-pos-lite'); ?>
                                    </td>
                                    <td class="text-right pr-0 font-weight-bold" id="orpl-subtotal">
                                        <?php echo esc_html($this->helpers->format_currency(0)); ?></td>
                                </tr>
                                <tr>
                                    <td class="pl-0"><?php esc_html_e('Discount:', 'obydullah-restaurant-pos-lite'); ?>
                                    </td>
                                    <td class="text-right pr-0">
                                        <input type="number" id="orpl-discount"
                                            class="form-control form-control-sm d-inline-block" value="0" min="0"
                                            step="0.01" style="width: 90px;">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="pl-0"><?php esc_html_e('Delivery:', 'obydullah-restaurant-pos-lite'); ?>
                                    </td>
                                    <td class="text-right pr-0">
                                        <input type="number" id="orpl-delivery"
                                            class="form-control form-control-sm d-inline-block" value="0" min="0"
                                            step="0.01" style="width: 90px;">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right pr-0" id="orpl-tax">
                                        <?php echo esc_html($this->helpers->format_currency(0)); ?></td>
                                </tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right pr-0" id="orpl-vat">
                                        <?php echo esc_html($this->helpers->format_currency(0)); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr class="border-top">
                                    <td class="pl-0 pt-2">
                                        <strong><?php esc_html_e('Total:', 'obydullah-restaurant-pos-lite'); ?></strong>
                                    </td>
                                    <td class="text-right pr-0 pt-2"><strong id="orpl-grand-total"
                                            class="text-primary"><?php echo esc_html($this->helpers->format_currency(0)); ?></strong>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="orpl-notes" class="form-control form-control-sm" rows="2"
                        placeholder="<?php esc_attr_e('Add any notes here...', 'obydullah-restaurant-pos-lite'); ?>"></textarea>
                </div>
...
<?php
    ...
    public function ajax_get_products_by_category()
    {
        ...
        WHERE p.status = %s AND s.quantity > 0",
            $product_status
        );
    ...
    public function ajax_process_sale()
    {
        ...
        try {
            ...
            $net_income = $delivery_cost + ($taxable_amount - $buy_price_total);

            // $revenue = $taxable_amount + $delivery_cost; // This is your real revenue
            // $gross_profit = $revenue - $buy_price_total; // This is your true gross profit
            ...
            if ($action === 'complete') {
                $accounting_data = [
                    'in_amount' => $net_income,     // Revenue from sale
