                    ...
                    <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="quantity" id="adjustment-quantity" type="number" min="1" value="1"
                        ...
                        <div class="alert alert-light border mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span
                                    class="text-dark"><?php esc_html_e('Current Stock:', 'obydullah-restaurant-pos-lite'); ?></span>
                                <span id="current-stock" class="fw-bold text-dark ml-1">0</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span
                                    class="text-dark"><?php esc_html_e('Adjustment:', 'obydullah-restaurant-pos-lite'); ?></span>
                                <span id="adjustment-display" class="fw-bold text-success ml-1">+0</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span
                                    class="text-dark"><?php esc_html_e('New Stock:', 'obydullah-restaurant-pos-lite'); ?></span>
                                <span id="new-stock" class="fw-bold text-danger ml-1">0</span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span
                                    class="text-dark"><?php esc_html_e('Buy Price:', 'obydullah-restaurant-pos-lite'); ?></span>
                                <span id="buy-price" class="fw-bold text-danger ml-1">0</span>
                            </div>
                        </div>
                        ...
                        <div class="search-group flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="position-relative flex-grow-1">
                                    <input type="text" id="adjustment-search" class="form-control form-control-sm"
                    ...
                    <table class="table table-striped table-hover table-bordered mb-2">
                        <thead>
                            <tr class="bg-primary text-white">
                                ...
                                <th class="text-right"><?php esc_html_e('Actions', 'obydullah-restaurant-pos-lite'); ?>
                                </th>
                            </tr>
                        </thead>
