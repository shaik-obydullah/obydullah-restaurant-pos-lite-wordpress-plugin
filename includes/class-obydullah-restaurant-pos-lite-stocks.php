                ...
                <form id="add-stock-form" method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-2 mb-md-0">
                            <label for="net-cost" class="form-label d-block mb-1">
                                <?php esc_html_e('Buy Price', 'obydullah-restaurant-pos-lite'); ?><span
                                    class="currency-symbol mr-2">
                                    (<?php echo esc_html($this->get_currency_symbol()); ?>)</span><span
                                    class="text-danger">*</span>
                            </label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-2 mb-md-0">
                            ...
                            <input name="quantity" id="stock-quantity" type="number" min="0" value="1"
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="status" id="stock-status" class="form-control">
                                <option value="inStock">
                                    <?php esc_html_e('In Stock', 'obydullah-restaurant-pos-lite'); ?></option>
                                <option value="outStock">
                                    <?php esc_html_e('Out of Stock', 'obydullah-restaurant-pos-lite'); ?></option>
                                <option value="lowStock">
                                    <?php esc_html_e('Low Stock', 'obydullah-restaurant-pos-lite'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-3 border rounded mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span
                                class="font-weight-bold"><?php esc_html_e('Profit Margin:', 'obydullah-restaurant-pos-lite'); ?>
                                &nbsp;</span>
                            <span id="profit-margin" class="profit-value font-weight-bold">0.00%</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <span
                                class="font-weight-bold"><?php esc_html_e('Total Profit: ', 'obydullah-restaurant-pos-lite'); ?></span>
                            <div class="d-flex align-items-center">
                ...
                <div class="search-section mb-3">
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        <div class="search-group flex-grow-1">
                            <label for="stock-search" class="form-label mb-1">
                                <?php esc_html_e('Search Stocks', 'obydullah-restaurant-pos-lite'); ?>
                            </label>
                            <div class="d-flex align-items-center gap-2">
                                <div class="position-relative flex-grow-1">
                                    ...
                                    <button type="button" id="clear-stock-search"
                ...
                <div class="row g-2 mb-3">
                    <div class="col-md-4">
                        <label for="status-filter" class="form-label small mb-1">
                            <?php esc_html_e('Stock Status', 'obydullah-restaurant-pos-lite'); ?>
                        </label>
                    ...
                    <div class="col-md-4">
                        <label for="quantity-filter" class="form-label small mb-1">
                            <?php esc_html_e('Quantity Range', 'obydullah-restaurant-pos-lite'); ?>
                        </label>
                        <select id="quantity-filter" class="form-control form-control-sm">
                            ...
                            <option value="low"><?php esc_html_e('Low (1-10)', 'obydullah-restaurant-pos-lite'); ?>
                            </option>
                            <option value="high"><?php esc_html_e('High (10+)', 'obydullah-restaurant-pos-lite'); ?>
                            </option>
                        </select>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-hover table-bordered mb-2">
                        <thead>
                            <tr class="bg-primary text-white">
                                <th><?php esc_html_e('Stock Name', 'obydullah-restaurant-pos-lite'); ?></th>
                                <th width="100"><?php esc_html_e('Buy Price', 'obydullah-restaurant-pos-lite'); ?></th>
                                <th width="100"><?php esc_html_e('Sale Price', 'obydullah-restaurant-pos-lite'); ?></th>
                                <th width="100"><?php esc_html_e('Quantity', 'obydullah-restaurant-pos-lite'); ?></th>
                    ...
                    <div class="tablenav-pages">
                        ...
                        <span class="pagination-links ms-2">
                            <a class="first-page btn btn-sm btn-dark" href="#"
                                title="<?php esc_attr_e('First page', 'obydullah-restaurant-pos-lite'); ?>">«</a>
                            <a class="prev-page btn btn-sm btn-dark" href="#"
                                title="<?php esc_attr_e('Previous page', 'obydullah-restaurant-pos-lite'); ?>">‹</a>
                            <span class="paging-input">
                                <input class="current-page form-control form-control-sm" id="current-page-selector"
                                    type="text" name="paged" value="1">
                                <span
                                    class="tablenav-paging-text"><?php esc_html_e('of', 'obydullah-restaurant-pos-lite'); ?>
                                    <span class="total-pages">1</span></span>
                            </span>
                            <a class="next-page btn btn-sm btn-dark" href="#"
                                title="<?php esc_attr_e('Next page', 'obydullah-restaurant-pos-lite'); ?>">›</a>
                            <a class="last-page btn btn-sm btn-dark" href="#"
                                title="<?php esc_attr_e('Last page', 'obydullah-restaurant-pos-lite'); ?>">»</a>
                        </span>
                    </div>
                    <div class="tablenav-pages">
...
<?php
    ...
    public function ajax_add_orpl_stock()
    {
        ...
        if ($net_cost <= 0) {
            wp_send_json_error(__('Buy Price must be greater than 0', 'obydullah-restaurant-pos-lite'));
        }
        if ($sale_cost <= 0) {
