...
class Obydullah_Restaurant_POS_Lite_Dashboard
{
    ...
    public function render_page()
    {
        ...
        ?>
<div class="wrap">
    <h1 class="wp-heading-inline mb-3"><?php esc_html_e('Restaurant POS Dashboard', 'obydullah-restaurant-pos-lite'); ?>
    </h1>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-info">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e('Stock Value', 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-info mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_currency($dashboard_data['stock_value'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Current inventory value', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-success">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e("Today's Sales", 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-success mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_number($dashboard_data['today_sale'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Completed orders today', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-primary">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e('Monthly Sales', 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-success mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_number($dashboard_data['month_sale'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Total orders this month', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-lime">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e("Today's Income", 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-lime mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_currency($dashboard_data['today_income'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Revenue generated today', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-success">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e('Monthly Income', 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-success mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_currency($dashboard_data['month_income'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Total revenue this month', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-warning">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e("Today's Expense", 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-warning mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_currency($dashboard_data['today_expense'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Expenses incurred today', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="bg-light p-4 rounded shadow-sm stock-summary-card border-left border-danger">
                <h3 class="fs-6 fw-normal text-muted mb-2">
                    <?php esc_html_e('Monthly Expense', 'obydullah-restaurant-pos-lite'); ?></h3>
                <p class="summary-number text-danger mb-0 fs-3 fw-bold">
                    <?php echo esc_html($this->format_currency($dashboard_data['month_expense'])); ?></p>
                <small
                    class="text-muted mb-3"><?php esc_html_e('Total expenses this month', 'obydullah-restaurant-pos-lite'); ?></small>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr class="bg-primary text-white">
                                ...
                                <th class="text-center"><?php esc_html_e('Orders', 'obydullah-restaurant-pos-lite'); ?>
                                </th>
                                <th class="text-center">
                                    <?php esc_html_e('Qty Sold', 'obydullah-restaurant-pos-lite'); ?></th>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="text-center py-5">
                    <div class="py-4">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="1.5" class="text-muted mb-3">
                            <path d="M3 3h18v18H3zM8 8v8m8-8v8m-4-4v4" />
                        </svg>
                        <p class="mb-0 text-muted">
                            <?php esc_html_e('No sales data available.', 'obydullah-restaurant-pos-lite'); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            </div>
